...
fn compile_ios(
    ...
    write_or_replace(
        &out_dir.join("Package.swift"),
        &format!(
            "// Generated by theurgy-runtime compile-native.\n// swift-tools-version: 6.0\nimport PackageDescription\n\nlet package = Package(name: \"{}-ios\", platforms: [.iOS(.v16)], products: [.executable(name: \"{}IOS\", targets: [\"Host\"])], targets: [.executableTarget(name: \"Host\", path: \"Host\")])\n",
            summary.app_id, summary.app_id
        ),
    )?;
    write_or_replace(
...
mod tests {
    ...
    fn compile_native_mobile_outputs_runtime_contract() {
        ...
        assert!(ios_package.contains("executableTarget(name: \"Host\", path: \"Host\")"));
